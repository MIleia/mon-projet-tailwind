...
<body class="bg-white text-gray-800" id="Niger">
    ...
    <header>
        <!-- Bandeau top -->
        <div id="Niger" class="bg-gray-100 text-sm border-b border-gray-300 py-2">
                                ...
                                <ul class="qdropdown-menu absolute left-0 hidden bg-white border border-gray-300 rounded shadow-md w-48 group-hover:block">
                                    ...
                                    <li>
                                        <a href="{{ route('accueil.benin') }}" class="flex items-center gap-2 px-4 py-2 text-gray-700 hover:text-green-600">
                                            <img src="https://flagcdn.com/w40/bj.png" alt="Benin" class="w-5 h-auto"> Bénin
                                        </a>
                                    </li>
                                    <li>
    ...
    <!-- CHIFFRES CLÉS -->
    <section class="py-20 px-6 bg-gray-50" id="Chiffres Niger">
    ...
    <!-- PRÉSENTATION -->
    <section class="py-20 px-6 bg-white" id="À propos de Pharmacol Niger">
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
            <div class="md:w-1/3 mb-8 md:mb-0 md:pr-6">
                <img src="{{ asset('images/Page accueil niger/directeur-niger.jpg') }}" alt="Directeur / équipe Pharmacol Niger" class="w-full rounded-lg shadow-lg">
            </div>
            <div class="md:w-2/3">
    ...
    <section class="py-20 px-6 bg-gray-100">
        <div class="max-w-6xl mx-auto grid md:grid-cols-5 gap-10 items-start">
            ...
            <div class="md:col-span-2">
                <div class="bg-white border rounded-xl shadow-lg p-4" id="Carte Niger">
                    <div id="map-niger" class="rounded w-full h-96"></div>
