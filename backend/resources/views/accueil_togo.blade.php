...
<body class="bg-white text-gray-800" id="Togo">
    ...
    <header>
        <!-- Bandeau top -->
        <div id="Togo" class="bg-gray-100 text-sm border-b border-gray-300 py-2">
    ...
    <!-- PRÉSENTATION -->
    <section class="py-20 px-6 bg-white" id="À propos de Pharmacol Togo">
        <div class="max-w-6xl mx-auto flex items-center justify-between">
            <div class="w-1/3 pr-6">
                <img src="{{ asset('images/Page accueil togo/PHOTO-DG-FOND-BIBLIO2-768x768.png') }}" alt="Pharmacol Togo" class="w-full rounded-lg shadow-lg">
            </div>
            <div class="w-2/3">
                <h2 class="text-2xl font-bold text-[#06788f] mb-6">À propos de Pharmacol Togo</h2>
    ...
    <section class="py-20 px-6 bg-gray-100">
        <div class="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 items-center">
            ...
            <!-- Carte du Togo -->
            <div class="bg-white border rounded-xl shadow-lg p-4" id="Carte-Togo">
