...
<body class="font-sans">
    ...
    <header>
        <!-- Bandeau top -->
        <div id ="Contact" class="bg-gray-100 text-sm border-b border-gray-300 py-2">
        ...
        <div class="relative z-10 qhero-prestations bg-cover bg-center h-40 sm:h-56 md:h-72" style="background-image: url('{{ asset('images/Page contact/medicine-capsules-global-health-with-geometric-pattern-digital-remix.jpg') }}');">
                ...
                <nav class="relative z-20">
                    <div class="qcontainer flex justify-center items-center px-4 py-3">
                        <ul class="qnav-links flex items-center space-x-8">
                            ...
                            <li><a href="{{ route('contact') }}" class="text-[#437305] hover:text-green-600 font-bold">Contact</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
            <!-- Texte "Contact" centré -->
        ...
        <div class="bg-[#437305] text-white relative flex flex-col pt-10 gap-8 w-full md:w-[420px] h-auto md:h-[660px] shadow-lg mb-20 md:mb-0">
            <div class="pl-8 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-white font-semibold text-[18px]">Gratuit +92 3800 8060</p>
                </div>  
            </div>
            <div class="pl-8 flex items-start gap-4">
                <div class="flex items-center justify-center bg-[#6b973d] rounded-full w-12 h-12">
                ...
                <div>
                    ...
                    <p class="text-white font-medium text-[14px]">contact@agence-pharmacol.com</p>
                </div>
            </div>
            ...
            <div class="flex gap-8 justify-around items-center text-[#3C74A8] bg-white w-[90%] max-w-[250px] h-[70px] px-7 mx-auto absolute md:bottom-[-30px] bottom-[-50px] left-1/2 -translate-x-1/2 shadow-lg">
                ...
                <a href="#"><i class="fab fa-pinterest-p text-xl"></i></a>
            </div>
        </div>
