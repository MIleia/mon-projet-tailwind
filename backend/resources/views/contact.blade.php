...
<body class="font-sans">
    ...
    <header>
        ...
        <div class="bg-[#3C74A8] border-b py-4">
            ...
            <div class="relative z-0 qhero-prestations bg-cover bg-center h-[300px]" style="background-image: url('images/Page contact/medicine-capsules-global-health-with-geometric-pattern-digital-remix.jpg');">
