...
<html lang="fr">
    ...
    <body class="bg-white text-gray-800">
        ...
        <header>
            ...
            <div class="relative z-0 qhero-prestations bg-cover bg-center h-[1000px]" style="background-image: url('images/Page index/side-view-researcher-biotechnology-laboratory-with-plant-test-tube.jpg');">
