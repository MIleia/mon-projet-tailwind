            ...
            <main class="ml-[20rem] w-full p-8 flex flex-col">
                        ...
                        <table class="min-w-full table-auto">
                            <thead class="justify-between">
                                <tr class="bg-gray-800">
                                    ...
                                    <th class="px-16 py-2">
                                        <span class="text-gray-300">Prénom</span>
                                    </th>
                ...
                <section id="settings" class="section-content hidden">
                    <div class="max-w-[100rem] p-8">
                        ...
                        <!-- Grille générale : 2 en haut, 1 en bas -->
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">

                            <!-- Bloc Togo -->
                            <div class="bg-white shadow-lg rounded-xl p-6">
                            <h3 class="text-xl font-bold mb-4">🇹🇬 Togo</h3>
                            <p class="mb-2">👥 Délégués sur le terrain : <strong>12</strong></p>
                            <p class="mb-4">🏢 Entreprises partenaires : <strong>8</strong></p>
                            ...
                            <!-- Bloc Bénin -->
                            <div class="bg-white shadow-lg rounded-xl p-6">
                            <h3 class="text-xl font-bold mb-4">🇧🇯 Bénin</h3>
                            <p class="mb-2">👥 Délégués sur le terrain : <strong>10</strong></p>
                            <p class="mb-4">🏢 Entreprises partenaires : <strong>5</strong></p>
                            ...
                            <div class="w-full h-64 bg-gray-200 flex items-center justify-center rounded">
                                <span class="text-gray-500">[Carte interactive Bénin]</span>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white shadow-lg rounded-xl p-6">
                            ...
                            <p class="mb-2">👥 Délégués sur le terrain : <strong>7</strong></p>
                            <p class="mb-4">🏢 Entreprises partenaires : <strong>4</strong></p>
