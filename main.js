...
const contents = {
  promotion: {
    ...
    text: `
      <h2 class="text-2xl font-bold text-[#3f73a3] mb-4 text-center">Promotion médicale</h2>
  ...
  encadrement: {
    ...
    text: `
      <h2 class="text-2xl font-bold text-[#3f73a3] mb-4 text-center">Encadrement force de vente</h2>
      <p class="text-gray-700 mb-4">
  ...
  representation: {
    ...
    text: `
      <h2 class="text-2xl font-bold text-[#3f73a3] mb-4 text-center">Représentation pharmaceutique</h2>
      <p class="text-gray-700 mb-4">
  ...
  autorisation: {
    ...
    text: `
      <h2 class="text-2xl font-bold text-[#3f73a3] mb-4 text-center">Autorisation sur le marché</h2>
      <p class="text-gray-700 mb-4">
  ...
  marketing: {
    ...
    text: `
      <h2 class="text-2xl font-bold text-[#3f73a3] mb-4 text-center">Marketing communication</h2>
      <p class="text-gray-700 mb-4">
  ...
  consulting: {
    title: "Consulting",
    text: `
      <h2 class="text-2xl font-bold text-[#3f73a3] mb-4 text-center">Consulting</h2>
      <p class="text-gray-700 mb-4">
