...
<html lang="fr">
    ...
    <body class="bg-white text-gray-800">
        ...
        <!-- HEADER identique à prestation.html -->
        <header>
            <!-- Bandeau top -->
            ...
            <!-- Bandeau Recrutement & navbar responsive -->
            <div class="relative z-0 qhero-prestations bg-cover bg-center h-40 sm:h-56 md:h-72" style="background-image: url('images/Page contact/medicine-capsules-global-health-with-geometric-pattern-digital-remix.jpg');">
                ...
                <div class="bg-white bg-opacity-100 backdrop-blur-md w-full md:w-[70%] mx-auto relative z-30">
                    <nav class="relative z-20">
                        <div class="qcontainer flex justify-around items-center px-4 py-3">
                            ...
                            <!-- Menu principal -->
                            <ul id="main-menu" class="qnav-links flex-col md:flex-row flex md:items-center md:space-x-8 absolute md:static top-full left-0 w-full md:w-auto bg-white md:bg-transparent shadow md:shadow-none z-40 transition-all duration-300 ease-in-out hidden md:flex">
                                ...
                                <li><a href="prestation.html" class="text-gray-900 hover:text-green-600 block px-4 py-3 md:p-0">Prestations</a></li>
                                <li><a href="recrutement.php" class="text-[#437305] hover:text-green-600 font-bold block px-4 py-3 md:p-0">Recrutement</a></li>
                                <li><a href="blog.html" class="text-gray-900 hover:text-green-600 block px-4 py-3 md:p-0">Blog</a></li>
                                <li><a href="contact.html" class="text-gray-900 hover:text-green-600 block px-4 py-3 md:p-0">Contact</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
        ...
        <!-- FOOTER identique à prestation.html -->
